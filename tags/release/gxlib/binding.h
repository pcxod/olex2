...
{
public:
  TSBond* Item(int index)  {  return &FData->Bond(index);  }
  virtual int Size()        {  return FData->BondCount();  }
};

class TXAtomSBondCollection: public TSBondCollection<TXAtom*>
{
public:
  TSBond* Item(int index)  {  return &FData->Atom().Bond(index);  }
  virtual int Size()        {  return FData->Atom().BondCount();  }
};
...
{
public:
  TSAtom* Item(int index)  {  return &FData->Node(index);  }
  virtual int Size()        {  return FData->NodeCount();  }
};

class TXAtomSAtomCollection: public TSAtomCollection<TXAtom*>
{
public:
  TSAtom* Item(int index)  {  return &FData->Atom().Node(index);  }
  virtual int Size()        {  return FData->Atom().NodeCount();  }
};
/******************************************************************************/
