...
namespace test {
  ...
  void SHA2Test(OlxTests& t) {
    t.description = __FUNC__;
    olxcstr msg("The quick brown fox jumps over the lazy dog"),
      msg1("930476899e3f6f90c6a0fef4589d56a3ce96c6f7-47e5-4a1f-a65c-39bc211495b3"),
      ...
      res256_2("d21f1473 8f489c9e 5c3cc972 f9b32916 a3daa52e 214cbd4b ae87ca02 387c5441"),
    ...
    if (!SHA256::Digest(msg1).Equalsi(res256_2)) {
      TBasicApp::NewLogEntry() << SHA256::Digest(msg1) << " vs \n" << res256_2;
      throw TFunctionFailedException(__OlxSourceInfo, "Wrong digest message");
    }
