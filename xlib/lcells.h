...
namespace lcells {
  ...
  struct Index {
    ...
    struct FolderEntry : public Entry {
      ...
      FolderEntry(FolderEntry *parent = 0)
        : Entry(parent)
      {}
      ...
      void Expand(TPtrList<FileEntry> &all);
    ...
    static olxstr DefaultIndex() {
      return TBasicApp::GetSharedDir() + "lcells.ind";
    }
  ...
  struct IndexManager {
    ...
    static olxstr DefaultCfgName() {
      return TBasicApp::GetSharedDir() + "lcells.xld";
    }
