...
static cm_Element _cm_element_H(0, "H", "Hydrogen", 0xFFFFFF, 1, 0.12, 0.32, 0.82, &_cm_gaussians_H, _cm_isotope_H, 2, _cm_henke_H, 501, &_cm_neutron_H);
static cm_Element _cm_element_He(1, "He", "Helium", 0x8000, 2, 0.3, 1.5, 2, &_cm_gaussians_He, _cm_isotope_He, 2, _cm_henke_He, 501, &_cm_neutron_He);
static cm_Element _cm_element_Li(2, "Li", "Lithium", 0x800080, 3, 0.16, 1.52, 2.02, &_cm_gaussians_Li, _cm_isotope_Li, 2, _cm_henke_Li, 501, &_cm_neutron_Li);
static cm_Element _cm_element_Be(3, "Be", "Beryllium", 0x8000, 4, 0.3, 1.11, 1.61, &_cm_gaussians_Be, _cm_isotope_Be, 1, _cm_henke_Be, 502, &_cm_neutron_Be);
static cm_Element _cm_element_B(4, "B", "Boron", 0xFFFF, 5, 0.2, 0.82, 1.32, &_cm_gaussians_B, _cm_isotope_B, 2, _cm_henke_B, 502, &_cm_neutron_B);
static cm_Element _cm_element_C(5, "C", "Carbon", 0x0, 6, 0.2, 0.77, 1.27, &_cm_gaussians_C, _cm_isotope_C, 2, _cm_henke_C, 502, &_cm_neutron_C);
static cm_Element _cm_element_N(6, "N", "Nitrogen", 0xFF0000, 7, 0.2, 0.7, 1.2, &_cm_gaussians_N, _cm_isotope_N, 2, _cm_henke_N, 503, &_cm_neutron_N);
static cm_Element _cm_element_O(7, "O", "Oxygen", 0xFF, 8, 0.2, 0.66, 1.16, &_cm_gaussians_O, _cm_isotope_O, 3, _cm_henke_O, 502, &_cm_neutron_O);
static cm_Element _cm_element_F(8, "F", "Fluorine", 0x8000, 9, 0.2, 0.64, 1.14, &_cm_gaussians_F, _cm_isotope_F, 1, _cm_henke_F, 502, &_cm_neutron_F);
static cm_Element _cm_element_Ne(9, "Ne", "Neon", 0x8000, 10, 0.3, 1.5, 2, &_cm_gaussians_Ne, _cm_isotope_Ne, 3, _cm_henke_Ne, 503, &_cm_neutron_Ne);
static cm_Element _cm_element_Na(10, "Na", "Sodium", 0x808000, 11, 0.2, 1.86, 2.36, &_cm_gaussians_Na, _cm_isotope_Na, 1, _cm_henke_Na, 504, &_cm_neutron_Na);
static cm_Element _cm_element_Mg(11, "Mg", "Magnesium", 0x8000, 12, 0.25, 1.6, 2.1, &_cm_gaussians_Mg, _cm_isotope_Mg, 3, _cm_henke_Mg, 504, &_cm_neutron_Mg);
static cm_Element _cm_element_Al(12, "Al", "Aluminium", 0x808000, 13, 0.25, 1.25, 1.75, &_cm_gaussians_Al, _cm_isotope_Al, 1, _cm_henke_Al, 504, &_cm_neutron_Al);
static cm_Element _cm_element_Si(13, "Si", "Silicon", 0xFF, 14, 0.3, 1.17, 1.67, &_cm_gaussians_Si, _cm_isotope_Si, 3, _cm_henke_Si, 504, &_cm_neutron_Si);
static cm_Element _cm_element_P(14, "P", "Phosphorus", 0x800080, 15, 0.3, 1.1, 1.6, &_cm_gaussians_P, _cm_isotope_P, 1, _cm_henke_P, 504, &_cm_neutron_P);
static cm_Element _cm_element_S(15, "S", "Sulfur", 0xFFFF, 16, 0.3, 1.03, 1.53, &_cm_gaussians_S, _cm_isotope_S, 4, _cm_henke_S, 504, &_cm_neutron_S);
static cm_Element _cm_element_Cl(16, "Cl", "Chlorine", 0x8000, 17, 0.3, 0.99, 1.49, &_cm_gaussians_Cl, _cm_isotope_Cl, 2, _cm_henke_Cl, 504, &_cm_neutron_Cl);
static cm_Element _cm_element_Ar(17, "Ar", "Argon", 0x8000, 18, 0.3, 1.5, 2, &_cm_gaussians_Ar, _cm_isotope_Ar, 3, _cm_henke_Ar, 506, &_cm_neutron_Ar);
static cm_Element _cm_element_K(18, "K", "Potassium", 0x808000, 19, 0.25, 1.27, 1.77, &_cm_gaussians_K, _cm_isotope_K, 3, _cm_henke_K, 503, &_cm_neutron_K);
static cm_Element _cm_element_Ca(19, "Ca", "Calcium", 0x8000, 20, 0.25, 1.97, 2.47, &_cm_gaussians_Ca, _cm_isotope_Ca, 6, _cm_henke_Ca, 504, &_cm_neutron_Ca);
static cm_Element _cm_element_Sc(20, "Sc", "Scandium", 0x8000, 21, 0.25, 1.61, 2.11, &_cm_gaussians_Sc, _cm_isotope_Sc, 1, _cm_henke_Sc, 504, &_cm_neutron_Sc);
static cm_Element _cm_element_Ti(21, "Ti", "Titanium", 0x8000, 22, 0.25, 1.45, 1.95, &_cm_gaussians_Ti, _cm_isotope_Ti, 5, _cm_henke_Ti, 504, &_cm_neutron_Ti);
static cm_Element _cm_element_V(22, "V", "Vanadium", 0x8000, 23, 0.25, 1.31, 1.81, &_cm_gaussians_V, _cm_isotope_V, 2, _cm_henke_V, 504, &_cm_neutron_V);
static cm_Element _cm_element_Cr(23, "Cr", "Chromium", 0x800080, 24, 0.25, 1.24, 1.74, &_cm_gaussians_Cr, _cm_isotope_Cr, 4, _cm_henke_Cr, 504, &_cm_neutron_Cr);
static cm_Element _cm_element_Mn(24, "Mn", "Manganese", 0x808000, 25, 0.25, 1.37, 1.87, &_cm_gaussians_Mn, _cm_isotope_Mn, 1, _cm_henke_Mn, 504, &_cm_neutron_Mn);
static cm_Element _cm_element_Fe(25, "Fe", "Iron", 0xFF, 26, 0.25, 1.24, 1.74, &_cm_gaussians_Fe, _cm_isotope_Fe, 4, _cm_henke_Fe, 504, &_cm_neutron_Fe);
static cm_Element _cm_element_Co(26, "Co", "Cobalt", 0xFF0000, 27, 0.25, 1.25, 1.75, &_cm_gaussians_Co, _cm_isotope_Co, 1, _cm_henke_Co, 504, &_cm_neutron_Co);
static cm_Element _cm_element_Ni(27, "Ni", "Nickel", 0x8000, 28, 0.25, 1.25, 1.75, &_cm_gaussians_Ni, _cm_isotope_Ni, 5, _cm_henke_Ni, 504, &_cm_neutron_Ni);
static cm_Element _cm_element_Cu(28, "Cu", "Copper", 0xFF, 29, 0.25, 1.28, 1.78, &_cm_gaussians_Cu, _cm_isotope_Cu, 2, _cm_henke_Cu, 504, &_cm_neutron_Cu);
static cm_Element _cm_element_Zn(29, "Zn", "Zinc", 0x8000, 30, 0.25, 1.33, 1.83, &_cm_gaussians_Zn, _cm_isotope_Zn, 5, _cm_henke_Zn, 504, &_cm_neutron_Zn);
static cm_Element _cm_element_Ga(30, "Ga", "Gallium", 0x8000, 31, 0.3, 1.26, 1.76, &_cm_gaussians_Ga, _cm_isotope_Ga, 2, _cm_henke_Ga, 506, &_cm_neutron_Ga);
static cm_Element _cm_element_Ge(31, "Ge", "Germanium", 0x8000, 32, 0.3, 1.22, 1.72, &_cm_gaussians_Ge, _cm_isotope_Ge, 5, _cm_henke_Ge, 506, &_cm_neutron_Ge);
static cm_Element _cm_element_As(32, "As", "Arsenic", 0x8000, 33, 0.3, 1.21, 1.71, &_cm_gaussians_As, _cm_isotope_As, 1, _cm_henke_As, 506, &_cm_neutron_As);
static cm_Element _cm_element_Se(33, "Se", "Selenium", 0xFFFF, 34, 0.3, 1.17, 1.67, &_cm_gaussians_Se, _cm_isotope_Se, 6, _cm_henke_Se, 506, &_cm_neutron_Se);
static cm_Element _cm_element_Br(34, "Br", "Bromine", 0xFF, 35, 0.3, 1.14, 1.64, &_cm_gaussians_Br, _cm_isotope_Br, 2, _cm_henke_Br, 506, &_cm_neutron_Br);
static cm_Element _cm_element_Kr(35, "Kr", "Krypton", 0x8000, 36, 0.3, 1.5, 2, &_cm_gaussians_Kr, _cm_isotope_Kr, 6, _cm_henke_Kr, 509, &_cm_neutron_Kr);
static cm_Element _cm_element_Rb(36, "Rb", "Rubidium", 0x8000, 37, 0.3, 2.48, 2.98, &_cm_gaussians_Rb, _cm_isotope_Rb, 2, _cm_henke_Rb, 508, &_cm_neutron_Rb);
static cm_Element _cm_element_Sr(37, "Sr", "Strontium", 0x8000, 38, 0.3, 1.15, 1.65, &_cm_gaussians_Sr, _cm_isotope_Sr, 4, _cm_henke_Sr, 508, &_cm_neutron_Sr);
static cm_Element _cm_element_Y(38, "Y", "Yttrium", 0x8000, 39, 0.3, 1.78, 2.28, &_cm_gaussians_Y, _cm_isotope_Y, 1, _cm_henke_Y, 508, &_cm_neutron_Y);
static cm_Element _cm_element_Zr(39, "Zr", "Zirconium", 0x8000, 40, 0.3, 1.59, 2.09, &_cm_gaussians_Zr, _cm_isotope_Zr, 5, _cm_henke_Zr, 508, &_cm_neutron_Zr);
static cm_Element _cm_element_Nb(40, "Nb", "Niobium", 0x8000, 41, 0.3, 1.43, 1.93, &_cm_gaussians_Nb, _cm_isotope_Nb, 1, _cm_henke_Nb, 508, &_cm_neutron_Nb);
static cm_Element _cm_element_Mo(41, "Mo", "Molybdenum", 0x8000, 42, 0.3, 1.36, 1.86, &_cm_gaussians_Mo, _cm_isotope_Mo, 7, _cm_henke_Mo, 508, &_cm_neutron_Mo);
static cm_Element _cm_element_Tc(42, "Tc", "Technetium", 0x8000, 43, 0.3, 1.35, 1.85, &_cm_gaussians_Tc, NULL, 0, _cm_henke_Tc, 508, &_cm_neutron_Tc);
static cm_Element _cm_element_Ru(43, "Ru", "Ruthenium", 0xFF, 44, 0.3, 1.33, 1.83, &_cm_gaussians_Ru, _cm_isotope_Ru, 7, _cm_henke_Ru, 508, &_cm_neutron_Ru);
static cm_Element _cm_element_Rh(44, "Rh", "Rhodium", 0x8000, 45, 0.3, 1.35, 1.85, &_cm_gaussians_Rh, _cm_isotope_Rh, 1, _cm_henke_Rh, 508, &_cm_neutron_Rh);
static cm_Element _cm_element_Pd(45, "Pd", "Palladium", 0x8000, 46, 0.3, 1.38, 1.88, &_cm_gaussians_Pd, _cm_isotope_Pd, 6, _cm_henke_Pd, 507, &_cm_neutron_Pd);
static cm_Element _cm_element_Ag(46, "Ag", "Silver", 0x800000, 47, 0.3, 1.44, 1.94, &_cm_gaussians_Ag, _cm_isotope_Ag, 2, _cm_henke_Ag, 508, &_cm_neutron_Ag);
static cm_Element _cm_element_Cd(47, "Cd", "Cadmium", 0x8000, 48, 0.3, 1.49, 1.99, &_cm_gaussians_Cd, _cm_isotope_Cd, 8, _cm_henke_Cd, 510, &_cm_neutron_Cd);
static cm_Element _cm_element_In(48, "In", "Indium", 0x8000, 49, 0.3, 1.44, 1.94, &_cm_gaussians_In, _cm_isotope_In, 2, _cm_henke_In, 510, &_cm_neutron_In);
static cm_Element _cm_element_Sn(49, "Sn", "Tin", 0xFFFF, 50, 0.3, 1.4, 1.9, &_cm_gaussians_Sn, _cm_isotope_Sn, 10, _cm_henke_Sn, 510, &_cm_neutron_Sn);
static cm_Element _cm_element_Sb(50, "Sb", "Antimony", 0xFF, 51, 0.3, 1.41, 1.91, &_cm_gaussians_Sb, _cm_isotope_Sb, 2, _cm_henke_Sb, 508, &_cm_neutron_Sb);
static cm_Element _cm_element_Te(51, "Te", "Tellurium", 0x8000, 52, 0.3, 1.37, 1.87, &_cm_gaussians_Te, _cm_isotope_Te, 8, _cm_henke_Te, 508, &_cm_neutron_Te);
static cm_Element _cm_element_I(52, "I", "Iodine", 0x800080, 53, 0.3, 1.33, 1.83, &_cm_gaussians_I, _cm_isotope_I, 1, _cm_henke_I, 508, &_cm_neutron_I);
static cm_Element _cm_element_Xe(53, "Xe", "Xenon", 0x8000, 54, 0.3, 1.5, 2, &_cm_gaussians_Xe, _cm_isotope_Xe, 9, _cm_henke_Xe, 509, &_cm_neutron_Xe);
static cm_Element _cm_element_Cs(54, "Cs", "Cesium", 0x8000, 55, 0.3, 2.65, 3.15, &_cm_gaussians_Cs, _cm_isotope_Cs, 1, _cm_henke_Cs, 508, &_cm_neutron_Cs);
static cm_Element _cm_element_Ba(55, "Ba", "Barium", 0x8000, 56, 0.3, 2.17, 2.67, &_cm_gaussians_Ba, _cm_isotope_Ba, 7, _cm_henke_Ba, 508, &_cm_neutron_Ba);
static cm_Element _cm_element_La(56, "La", "Lanthanum", 0x8000, 57, 0.3, 1.87, 2.37, &_cm_gaussians_La, _cm_isotope_La, 2, _cm_henke_La, 508, &_cm_neutron_La);
static cm_Element _cm_element_Ce(57, "Ce", "Cerium", 0x8000, 58, 0.3, 1.83, 2.33, &_cm_gaussians_Ce, _cm_isotope_Ce, 4, _cm_henke_Ce, 508, &_cm_neutron_Ce);
static cm_Element _cm_element_Pr(58, "Pr", "Praseodymium", 0x8000, 59, 0.3, 1.82, 2.32, &_cm_gaussians_Pr, _cm_isotope_Pr, 1, _cm_henke_Pr, 508, &_cm_neutron_Pr);
static cm_Element _cm_element_Nd(59, "Nd", "Neodymium", 0x8000, 60, 0.3, 1.81, 2.31, &_cm_gaussians_Nd, _cm_isotope_Nd, 7, _cm_henke_Nd, 508, &_cm_neutron_Nd);
static cm_Element _cm_element_Pm(60, "Pm", "Promethium", 0x8000, 61, 0.3, 1.81, 2.31, &_cm_gaussians_Pm, NULL, 0, _cm_henke_Pm, 508, &_cm_neutron_Pm);
static cm_Element _cm_element_Sm(61, "Sm", "Samarium", 0x8000, 62, 0.3, 1.8, 2.3, &_cm_gaussians_Sm, _cm_isotope_Sm, 7, _cm_henke_Sm, 508, &_cm_neutron_Sm);
static cm_Element _cm_element_Eu(62, "Eu", "Europium", 0x8000, 63, 0.3, 2, 2.5, &_cm_gaussians_Eu, _cm_isotope_Eu, 2, _cm_henke_Eu, 514, &_cm_neutron_Eu);
static cm_Element _cm_element_Gd(63, "Gd", "Gadolinium", 0x8000, 64, 0.3, 1.79, 2.29, &_cm_gaussians_Gd, _cm_isotope_Gd, 7, _cm_henke_Gd, 514, &_cm_neutron_Gd);
static cm_Element _cm_element_Tb(64, "Tb", "Terbium", 0x8000, 65, 0.3, 1.76, 2.26, &_cm_gaussians_Tb, _cm_isotope_Tb, 1, _cm_henke_Tb, 514, &_cm_neutron_Tb);
static cm_Element _cm_element_Dy(65, "Dy", "Dysprosium", 0x8000, 66, 0.3, 1.75, 2.25, &_cm_gaussians_Dy, _cm_isotope_Dy, 7, _cm_henke_Dy, 514, &_cm_neutron_Dy);
static cm_Element _cm_element_Ho(66, "Ho", "Holmium", 0x8000, 67, 0.3, 1.74, 2.24, &_cm_gaussians_Ho, _cm_isotope_Ho, 1, _cm_henke_Ho, 514, &_cm_neutron_Ho);
static cm_Element _cm_element_Er(67, "Er", "Erbium", 0x8000, 68, 0.3, 1.73, 2.23, &_cm_gaussians_Er, _cm_isotope_Er, 6, _cm_henke_Er, 514, &_cm_neutron_Er);
static cm_Element _cm_element_Tm(68, "Tm", "Thulium", 0x8000, 69, 0.3, 1.72, 2.22, &_cm_gaussians_Tm, _cm_isotope_Tm, 1, _cm_henke_Tm, 514, &_cm_neutron_Tm);
static cm_Element _cm_element_Yb(69, "Yb", "Ytterbium", 0x8000, 70, 0.3, 1.94, 2.44, &_cm_gaussians_Yb, _cm_isotope_Yb, 7, _cm_henke_Yb, 514, &_cm_neutron_Yb);
static cm_Element _cm_element_Lu(70, "Lu", "Lutetium", 0x8000, 71, 0.3, 1.72, 2.22, &_cm_gaussians_Lu, _cm_isotope_Lu, 2, _cm_henke_Lu, 514, &_cm_neutron_Lu);
static cm_Element _cm_element_Hf(71, "Hf", "Hafnium", 0x8000, 72, 0.3, 1.56, 2.06, &_cm_gaussians_Hf, _cm_isotope_Hf, 6, _cm_henke_Hf, 514, &_cm_neutron_Hf);
static cm_Element _cm_element_Ta(72, "Ta", "Tantalum", 0x8000, 73, 0.3, 1.43, 1.93, &_cm_gaussians_Ta, _cm_isotope_Ta, 2, _cm_henke_Ta, 514, &_cm_neutron_Ta);
static cm_Element _cm_element_W(73, "W", "Tungsten", 0x8000, 74, 0.3, 1.37, 1.87, &_cm_gaussians_W, _cm_isotope_W, 5, _cm_henke_W, 516, &_cm_neutron_W);
static cm_Element _cm_element_Re(74, "Re", "Rhenium", 0x8000, 75, 0.3, 1.37, 1.87, &_cm_gaussians_Re, _cm_isotope_Re, 2, _cm_henke_Re, 516, &_cm_neutron_Re);
static cm_Element _cm_element_Os(75, "Os", "Osmium", 0x800000, 76, 0.3, 1.34, 1.84, &_cm_gaussians_Os, _cm_isotope_Os, 7, _cm_henke_Os, 516, &_cm_neutron_Os);
static cm_Element _cm_element_Ir(76, "Ir", "Iridium", 0x8000, 77, 0.3, 1.36, 1.86, &_cm_gaussians_Ir, _cm_isotope_Ir, 2, _cm_henke_Ir, 515, &_cm_neutron_Ir);
static cm_Element _cm_element_Pt(77, "Pt", "Platinum", 0x800000, 78, 0.3, 1.37, 1.87, &_cm_gaussians_Pt, _cm_isotope_Pt, 6, _cm_henke_Pt, 516, &_cm_neutron_Pt);
static cm_Element _cm_element_Au(78, "Au", "Gold", 0xFFFF, 79, 0.3, 1.44, 1.94, &_cm_gaussians_Au, _cm_isotope_Au, 1, _cm_henke_Au, 506, &_cm_neutron_Au);
static cm_Element _cm_element_Hg(79, "Hg", "Mercury", 0xFFFF, 80, 0.3, 1.5, 2, &_cm_gaussians_Hg, _cm_isotope_Hg, 7, _cm_henke_Hg, 516, &_cm_neutron_Hg);
static cm_Element _cm_element_Tl(80, "Tl", "Thallium", 0x8000, 81, 0.3, 1.64, 2.14, &_cm_gaussians_Tl, _cm_isotope_Tl, 2, _cm_henke_Tl, 516, &_cm_neutron_Tl);
static cm_Element _cm_element_Pb(81, "Pb", "Lead", 0x8000, 82, 0.3, 1.6, 2.1, &_cm_gaussians_Pb, _cm_isotope_Pb, 4, _cm_henke_Pb, 516, &_cm_neutron_Pb);
static cm_Element _cm_element_Bi(82, "Bi", "Bismuth", 0x8000, 83, 0.3, 1.6, 2.1, &_cm_gaussians_Bi, _cm_isotope_Bi, 1, _cm_henke_Bi, 516, &_cm_neutron_Bi);
static cm_Element _cm_element_Po(83, "Po", "Polonium", 0x8000, 84, 0.3, 1.6, 2.1, &_cm_gaussians_Po, NULL, 0, _cm_henke_Po, 516, &_cm_neutron_Po);
static cm_Element _cm_element_At(84, "At", "Astatine", 0x8000, 85, 0.3, 1.6, 2.1, &_cm_gaussians_At, NULL, 0, _cm_henke_At, 516, &_cm_neutron_At);
static cm_Element _cm_element_Rn(85, "Rn", "Radon", 0x8000, 86, 0.3, 1.8, 2.3, &_cm_gaussians_Rn, NULL, 0, _cm_henke_Rn, 516, &_cm_neutron_Rn);
static cm_Element _cm_element_Fr(86, "Fr", "Francium", 0x8000, 87, 0.3, 2.8, 3.3, &_cm_gaussians_Fr, NULL, 0, _cm_henke_Fr, 516, &_cm_neutron_Fr);
static cm_Element _cm_element_Ra(87, "Ra", "Radium", 0x8000, 88, 0.3, 2.2, 2.7, &_cm_gaussians_Ra, NULL, 0, _cm_henke_Ra, 516, &_cm_neutron_Ra);
static cm_Element _cm_element_Ac(88, "Ac", "Actinium", 0x8000, 89, 0.3, 1.9, 2.4, &_cm_gaussians_Ac, NULL, 0, _cm_henke_Ac, 516, &_cm_neutron_Ac);
static cm_Element _cm_element_Th(89, "Th", "Thorium", 0x8000, 90, 0.3, 1.85, 2.35, &_cm_gaussians_Th, _cm_isotope_Th, 1, _cm_henke_Th, 516, &_cm_neutron_Th);
static cm_Element _cm_element_Pa(90, "Pa", "Protactinium", 0x8000, 91, 0.3, 1.8, 2.3, &_cm_gaussians_Pa, _cm_isotope_Pa, 1, _cm_henke_Pa, 516, &_cm_neutron_Pa);
static cm_Element _cm_element_U(91, "U", "Uranium", 0x8000, 92, 0.3, 1.8, 2.3, &_cm_gaussians_U, _cm_isotope_U, 3, _cm_henke_U, 514, &_cm_neutron_U);
static cm_Element _cm_element_Np(92, "Np", "Neptunium", 0x8000, 93, 0.3, 1.8, 2.3, &_cm_gaussians_Np, NULL, 0, NULL, 0, &_cm_neutron_Np);
static cm_Element _cm_element_Pu(93, "Pu", "Plutonium", 0x8000, 94, 0.3, 1.8, 2.3, &_cm_gaussians_Pu, NULL, 0, NULL, 0, NULL);
static cm_Element _cm_element_Am(94, "Am", "Americium", 0x8000, 95, 0.3, 1.8, 2.3, &_cm_gaussians_Am, NULL, 0, NULL, 0, &_cm_neutron_Am);
static cm_Element _cm_element_Cm(95, "Cm", "Curium", 0x8000, 96, 0.3, 1.8, 2.3, &_cm_gaussians_Cm, NULL, 0, NULL, 0, NULL);
static cm_Element _cm_element_Bk(96, "Bk", "Berkelium", 0x8000, 97, 0.3, 1.8, 2.3, &_cm_gaussians_Bk, NULL, 0, NULL, 0, NULL);
static cm_Element _cm_element_Cf(97, "Cf", "Californium", 0x8000, 98, 0.3, 1.8, 2.3, &_cm_gaussians_Cf, NULL, 0, NULL, 0, NULL);
static cm_Element _cm_element_Es(98, "Es", "Einsteinium", 0x8000, 99, 0.3, 1.8, 2.3, NULL, NULL, 0, NULL, 0, NULL);
static cm_Element _cm_element_Fm(99, "Fm", "Fermium", 0x8000, 100, 0.3, 1.8, 2.3, NULL, NULL, 0, NULL, 0, NULL);
static cm_Element _cm_element_Md(100, "Md", "Mendelevium", 0x8000, 101, 0.3, 1.8, 2.3, NULL, NULL, 0, NULL, 0, NULL);
static cm_Element _cm_element_No(101, "No", "Nobelium", 0x8000, 102, 0.3, 1.8, 2.3, NULL, NULL, 0, NULL, 0, NULL);
static cm_Element _cm_element_Lr(102, "Lr", "Lawrencium", 0x8000, 103, 0.3, 1.8, 2.3, NULL, NULL, 0, NULL, 0, NULL);
static cm_Element _cm_element_Ku(103, "Ku", "?", 0x8000, 104, 0.3, 1.8, 2.3, NULL, NULL, 0, NULL, 0, NULL);
static cm_Element _cm_element_Q(104, "Q", "Peak", 0x0, -1, 0.2, 0.77, 1.27, NULL, NULL, 0, NULL, 0, NULL);
static cm_Element _cm_element_D(105, "D", "Deuterium", 0xFFFFFF, 1, 0.12, 0.32, 0.82, &_cm_gaussians_H, _cm_isotope_H, 2, _cm_henke_H, 501, &_cm_neutron_H2);
